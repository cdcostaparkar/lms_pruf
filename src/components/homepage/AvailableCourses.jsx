            ...
            {roleName === "student" ? (
                <div>
                    {studentEnrolledCourses.length > 0 ? (
                        <>
                            <h2 className="course-progress-heading">
                                {" "}
                                Continue Learning (
                    ...
                    <h2 className="available-courses-heading">
                        Available Courses (
                        <span className="text-purple-500">
                            {studentNotEnrolledCourses.length}
                        </span>
                        )
                    </h2>
                                    ...
                                    <Card className="h-96 flex flex-col">
                                        ...
                                        <CardContent className="flex flex-col justify-between p-6 space-y-4 flex-grow">
                                            <div>
                                                ...
                                                <div className="grid grid-cols-2 gap-2 text-sm text-dark-gray">
                                                    <div>
                                                        <span>Course By:</span>
